...
namespace Legyen_ön_is_Milliomos
{
    public partial class Zenefelismero : Form
    {
        ...
        private void valaszD_Click_1(object sender, EventArgs e)
        {
            if (dontRunHandler)
            {
                betu = "D";
        ...
        private void valaszC_Click_1(object sender, EventArgs e)
        {
            if (dontRunHandler)
            {
                betu = "C";
        ...
        private void valaszB_Click_1(object sender, EventArgs e)
        {
            if (dontRunHandler)
            {
                betu = "B";
